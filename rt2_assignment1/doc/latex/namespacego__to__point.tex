...
def \mbox{\hyperlink{namespacego__to__point_aaa40c80713fb412b556666585e35e508}{velocity\+\_\+clbk}} (velocity)
...
def \mbox{\hyperlink{namespacego__to__point_aeabc057cb3ea91a0d632b618eec6e961}{time\+\_\+check}} (e\+\_\+t)
...
\item 
\mbox{\hyperlink{namespacego__to__point_a59ee40a427452666310807580d5bf9b8}{vel}} = Twist()
\item 
...
{\em state} & (int)\+: new updated state \\
\hline
\end{DoxyParams}
...
Definition at line 100 of file go\+\_\+to\+\_\+point.\+py.
...
This function is the Odometry callback It retrieves (x,y,theta) from the Odom message. 
...
Definition at line 76 of file go\+\_\+to\+\_\+point.\+py.
...
Definition at line 229 of file go\+\_\+to\+\_\+point.\+py.
...
This function orients the robot in the desidered orientation, based the error between the current orientation and the desired one. 

It sets the angular velocity to obtain the desidered orientation. It also updates the state to done, once the orientation is set.


\begin{DoxyParams}{Parameters}
{\em des\+\_\+yaw} & (float)\+: desidered (theta) position \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\+: None 
...
Definition at line 201 of file go\+\_\+to\+\_\+point.\+py.
...
\begin{DoxyEnumerate}
\item When the robot has to be oriented toward the goal (x,y) position.
\item When the robot has already reached the goal (x,y) position and it has to achieve the goal orientation. It sets the angular velocity to reach the goal position. It also updates the state to the behavior go\+\_\+straight, based on the orientation error.
\end{DoxyEnumerate}


\begin{DoxyParams}{Parameters}
{\em des\+\_\+pos} & ((Point)\+: desidered (x,y) position \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\+: None 
...
Definition at line 135 of file go\+\_\+to\+\_\+point.\+py.
...
This function implements the behavior that allows the robot to reach the goal. 

It sets the linear and angular velocities depending on the distance to the goal pose.
...
Definition at line 167 of file go\+\_\+to\+\_\+point.\+py.
...
It sets the correct behavior that the robot will follow, based on the current robot state. The F\+MS continues until the goal is reached or the goal is cancelled


\begin{DoxyParams}{Parameters}
{\em req} & (Moving\+Action\+Goal)\+:(x,y,theta) goal pose) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\+: None 
...
Definition at line 251 of file go\+\_\+to\+\_\+point.\+py.
...
Definition at line 296 of file go\+\_\+to\+\_\+point.\+py.
...
This function normalizes the angle between \mbox{[}-\/pi,pi\mbox{]}. 
...
Definition at line 112 of file go\+\_\+to\+\_\+point.\+py.

\mbox{\Hypertarget{namespacego__to__point_aeabc057cb3ea91a0d632b618eec6e961}\label{namespacego__to__point_aeabc057cb3ea91a0d632b618eec6e961}} 
\index{go\_to\_point@{go\_to\_point}!time\_check@{time\_check}}
\index{time\_check@{time\_check}!go\_to\_point@{go\_to\_point}}
\doxysubsubsection{\texorpdfstring{time\_check()}{time\_check()}}
{\footnotesize\ttfamily def go\+\_\+to\+\_\+point.\+time\+\_\+check (\begin{DoxyParamCaption}\item[{}]{e\+\_\+t }\end{DoxyParamCaption})}
...
Definition at line 242 of file go\+\_\+to\+\_\+point.\+py.

\mbox{\Hypertarget{namespacego__to__point_aaa40c80713fb412b556666585e35e508}\label{namespacego__to__point_aaa40c80713fb412b556666585e35e508}} 
\index{go\_to\_point@{go\_to\_point}!velocity\_clbk@{velocity\_clbk}}
\index{velocity\_clbk@{velocity\_clbk}!go\_to\_point@{go\_to\_point}}
\doxysubsubsection{\texorpdfstring{velocity\_clbk()}{velocity\_clbk()}}
{\footnotesize\ttfamily def go\+\_\+to\+\_\+point.\+velocity\+\_\+clbk (\begin{DoxyParamCaption}\item[{}]{velocity }\end{DoxyParamCaption})}



The data received on the topic /vel are saved in vel, a global variable of type Twist. 


\begin{DoxyParams}{Parameters}
{\em velocity} & (float)\+: input velocity \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\+: None 
...
\mbox{\Hypertarget{namespacego__to__point_a59ee40a427452666310807580d5bf9b8}\label{namespacego__to__point_a59ee40a427452666310807580d5bf9b8}} 
...
Definition at line 54 of file go\+\_\+to\+\_\+point.\+py.
...
Definition at line 73 of file go\+\_\+to\+\_\+point.\+py.
